...
async fn transfer_less_than_balance() {
    // TODO: mint public tokens to account_0, transfer less than balance to account_1,
    //       verify both balances
    todo!("mirror upstream: transfer less than balance")
}

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn transfer_to_self() {
    // TODO: mint public tokens, transfer to self, verify balance unchanged
    todo!("mirror upstream: transfer to self")
}

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn transfer_on_behalf_of_other() {
    // TODO: mint public tokens, create public authwit, transfer on behalf, verify balances
...
async fn transfer_more_than_balance() {
    // TODO: attempt public transfer exceeding balance, expect revert
    todo!("mirror upstream: transfer more than balance")
}

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn transfer_on_behalf_of_self_with_non_zero_nonce() {
    // TODO: attempt public transfer on behalf of self with nonce != 0, expect revert
...
async fn transfer_on_behalf_of_other_without_approval() {
    // TODO: attempt public transfer without authwit, expect revert
...
async fn transfer_on_behalf_of_other_cancelled_authwit_flow_2() {
    // TODO: create authwit, cancel via flow 2, attempt transfer, expect revert
    todo!("mirror upstream: transfer on behalf of other, cancelled authwit, flow 2")
}

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn transfer_on_behalf_of_other_invalid_spend_public_authwit() {
    // TODO: create invalid spend_public_authwit on "from", attempt transfer, expect revert
    todo!("mirror upstream: transfer on behalf of other, invalid spend_public_authwit on from")
}

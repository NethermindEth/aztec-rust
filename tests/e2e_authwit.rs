...
// TODO: need an auth_contract artifact (AuthContract or SchnorrAccount)
...
// ---------------------------------------------------------------------------
// Tests: e2e_authwit — Private
// ---------------------------------------------------------------------------

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn private_authwit_arbitrary_data_happy_path() {
    // TODO: create a private authwit with arbitrary data, consume it, verify success
    todo!("mirror upstream: Private > arbitrary data > happy path")
}

// ---------------------------------------------------------------------------
// Tests: e2e_authwit — Public
// ---------------------------------------------------------------------------

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn public_authwit_arbitrary_data_happy_path() {
    // TODO: create a public authwit with arbitrary data, consume it, verify success
    todo!("mirror upstream: Public > arbitrary data > happy path")
}

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn public_authwit_cancel_before_usage() {
    // TODO: create a public authwit, cancel it before consumption, verify rejection
    todo!("mirror upstream: Public > arbitrary data > failure case > cancel before usage")
}

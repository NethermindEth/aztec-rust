...
async fn transfer_to_public_on_behalf_of_self() {
    // TODO: mint private tokens, call transfer_to_public on behalf of self,
    //       verify private balance decreased and public balance increased
    todo!("mirror upstream: on behalf of self")
}

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn transfer_to_public_on_behalf_of_other() {
    // TODO: mint private tokens to account_0, create authwit for account_1,
    //       call transfer_to_public on behalf of account_0, verify balances
    todo!("mirror upstream: on behalf of other")
}
...
async fn transfer_to_public_on_behalf_of_self_more_than_balance() {
    // TODO: attempt transfer_to_public exceeding private balance, expect revert
    todo!("mirror upstream: on behalf of self (more than balance)")
}

#[tokio::test]
#[ignore = "requires live node via AZTEC_NODE_URL"]
async fn transfer_to_public_on_behalf_of_self_invalid_authwit_nonce() {
    // TODO: attempt transfer_to_public with invalid authwit nonce, expect revert
    todo!("mirror upstream: on behalf of self (invalid authwit nonce)")
}
...
async fn transfer_to_public_on_behalf_of_other_more_than_balance() {
    ...
    todo!("mirror upstream: on behalf of other (more than balance)")
}
...
async fn transfer_to_public_on_behalf_of_other_invalid_designated_caller() {
    ...
    todo!("mirror upstream: on behalf of other (invalid designated caller)")
}
